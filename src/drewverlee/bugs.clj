;; TODO picture bugs eathing zuchhini plant

;; How do you fix bugs in your software? Is there a process, and if so, can
;; it be taught, or is it a path can only be walked?

;; These quetions came to me on the heels of another that I was asked recently on a
;; job application:
...
;; ;; Here at the end I promised i would explain why its better to avoid searching for the answer to early before your very sure what your looking for. As an example inital search results for this problem bring up this [SO]( https://stackoverflow.com/questions/877728/what-algorithm-to-use-to-determine-minimum-number-of-actions-required-to-get-the)
